...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#pilihSemua').click(function(e) {
            if ($(this).is(':checked')) {
                $('.pilihDatang').prop('checked', true);
            } else {
                $('.pilihDatang').prop('checked', false);
            }
        });

        $('.formhapus').submit(function(e) {
            e.preventDefault();
            let jmldata = $('.pilihDatang:checked');
            if (jmldata.length === 0) {
                Swal.fire({
                    icon: 'error',
                    title: 'Ooops!',
