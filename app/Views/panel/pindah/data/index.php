            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3">DATA PINDAH KOTA MOJOKERTO</h4>
                        <form method="POST" action="<?= base_url('/pindah/filter') ?>">
                          <div class="row mb-3">
                            <div class="col">
                              <label for="bulan">BULAN PINDAH<code>*</code></label>
                            ...
                            <div class="col">
                              <label for="tahun">TAHUN PINDAH<code>*</code></label>
