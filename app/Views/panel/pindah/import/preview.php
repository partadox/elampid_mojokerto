    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <form id="save_form" action="<?= base_url('/pindah-import/save') ?>" method="post">
                        <h4 class="card-title mb-3">IMPORT PREVIEW DATA PINDAH KOTA MOJOKERTO</h4>
                        <div class="row mb-3">
                          <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-row-reverse">
                            ...
                            <div class="p-2">
                                <a class="btn btn-danger" href="<?= base_url('/pindah-import') ?>"> <i class="bx bx-x"></i> Batal</a>
                            </div>
                        </div>
                        </form>
                    </div>
            ...
            error: function(response) {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'OK'
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '/pindah-import';
                        }
                });
            }
        });
