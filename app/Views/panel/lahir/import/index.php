    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-3">IMPORT DATA KELAHIRAN KOTA MOJOKERTO</h4>
                        <form action="<?= base_url('lahir-import/import') ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="card border border-danger mt-3">
                              ...
                              <div class="card-body">
                                  <ul>
                                    <li>Untuk melakukan import data harap gunakan template excel yang disediakan, <u><strong><a href="public/assets/template/Lahir-Template-Import.xlsx" style="color: green;"><i class="fa fa-file-excel"></i> Download Template</a></strong></u></li>
