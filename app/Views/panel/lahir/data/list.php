...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#pilihSemua').click(function(e) {
            if ($(this).is(':checked')) {
                $('.pilihLahir').prop('checked', true);
            } else {
                $('.pilihLahir').prop('checked', false);
            }
        });

        $('.formhapus').submit(function(e) {
            e.preventDefault();
            let jmldata = $('.pilihLahir:checked');
            if (jmldata.length === 0) {
                Swal.fire({
                    icon: 'error',
                    title: 'Ooops!',
