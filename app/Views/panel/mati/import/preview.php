    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <form id="save_form" action="<?= base_url('/mati-import/save') ?>" method="post">
                        <h4 class="card-title mb-3">IMPORT PREVIEW DATA KEMATIAN KOTA MOJOKERTO</h4>
                        <div class="row mb-3">
                          <div class="col-sm-6">
                        ...
                        <div class="table-responsive">
                            <table id="preview_table_mati" class="table table-striped table-bordered dt-responsive wrap w-100">
                                <thead>
                                    <tr>
                                        <th>NO</th>
                                        <th>AKTA</th>
                                ...
                                <tbody>
                                    ...
                                    <tr data-row-id="<?= $index ?>">
                                        ...
                                        <td>
                                            <button class="btn btn-outline-danger delete-btn-mati mb-2"><i class="bx bx-trash"></i></button>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                        ...
                        <div class="d-flex flex-row-reverse">
                            ...
                            <div class="p-2">
                                <a class="btn btn-danger" href="<?= base_url('/mati-import') ?>"> <i class="bx bx-x"></i> Batal</a>
                            </div>
                        </div>
                        </form>
                    </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.delete-btn-mati', function() {
            ...
            error: function(response) {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'OK'
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '/mati-import';
                        }
                });
            }
        });
