            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3">DATA KEMATIAN KOTA MOJOKERTO</h4>
                        <form method="POST" action="<?= base_url('/mati/filter') ?>">
                          <div class="row mb-3">
                            <div class="col">
                              <label for="bulan">BULAN KEMATIAN<code>*</code></label>
                            ...
                            <div class="col">
                              <label for="tahun">TAHUN KEMATIAN<code>*</code></label>
