    ...
    public function export()
    {
        ...
        foreach ($kecamatan as $kec) {
            for ($i=1; $i <= 12 ; $i++) { 
                ...
                $query   = $this->db->query("SELECT COUNT(*) AS '$as' FROM tb_data_lahir WHERE EXTRACT(YEAR FROM tgl_entri) = $tahun AND EXTRACT(MONTH FROM tgl_entri) = $i AND kecamatan = '$kc'");
        ...
        foreach ($kelurahan as $kel) {
            for ($i=1; $i <= 12 ; $i++) { 
                ...
                $query   = $this->db->query("SELECT COUNT(*) AS '$as' FROM tb_data_lahir WHERE EXTRACT(YEAR FROM tgl_entri) = $tahun AND EXTRACT(MONTH FROM tgl_entri) = $i AND kelurahan = '$kl' AND kelamin = 'LAKI-LAKI'");
        ...
        foreach ($kelurahan as $kel) {
            for ($i=1; $i <= 12 ; $i++) { 
                ...
                $query   = $this->db->query("SELECT COUNT(*) AS '$as' FROM tb_data_lahir WHERE EXTRACT(YEAR FROM tgl_entri) = $tahun AND EXTRACT(MONTH FROM tgl_entri) = $i AND kelurahan = '$kl' AND kelamin = 'PEREMPUAN'");
        ...
        foreach ($kelurahan as $kel) {
            for ($i=1; $i <= 12 ; $i++) { 
                ...
                $query   = $this->db->query("SELECT COUNT(*) AS '$as' FROM tb_data_lahir WHERE EXTRACT(YEAR FROM tgl_entri) = $tahun AND EXTRACT(MONTH FROM tgl_entri) = $i AND kelurahan = '$kl' AND kategori = 'LT'");
        ...
        foreach ($kelurahan as $kel) {
            for ($i=1; $i <= 12 ; $i++) { 
                ...
                $query   = $this->db->query("SELECT COUNT(*) AS '$as' FROM tb_data_lahir WHERE EXTRACT(YEAR FROM tgl_entri) = $tahun AND EXTRACT(MONTH FROM tgl_entri) = $i AND kelurahan = '$kl' AND kategori = 'LU'");
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('C19', $t2['L-gununggedangan-1'])
            ->setCellValue('D19', $t2['P-gununggedangan-1'])
            ->setCellValue('E19', $t2['L-gununggedangan-2'])
            ->setCellValue('F19', $t2['P-gununggedangan-2'])
            ->setCellValue('G19', $t2['L-gununggedangan-3'])
            ->setCellValue('H19', $t2['P-gununggedangan-3'])
            ->setCellValue('I19', $t2['L-gununggedangan-4'])
            ->setCellValue('J19', $t2['P-gununggedangan-4'])
            ->setCellValue('K19', $t2['L-gununggedangan-5'])
            ->setCellValue('L19', $t2['P-gununggedangan-5'])
            ->setCellValue('M19', $t2['L-gununggedangan-6'])
            ->setCellValue('N19', $t2['P-gununggedangan-6'])
            ->setCellValue('O19', $t2['L-gununggedangan-7'])
            ->setCellValue('P19', $t2['P-gununggedangan-7'])
            ->setCellValue('Q19', $t2['L-gununggedangan-8'])
            ->setCellValue('R19', $t2['P-gununggedangan-8'])
            ->setCellValue('S19', $t2['L-gununggedangan-9'])
            ->setCellValue('T19', $t2['P-gununggedangan-9'])
            ->setCellValue('U19', $t2['L-gununggedangan-10'])
            ->setCellValue('V19', $t2['P-gununggedangan-10'])
            ->setCellValue('W19', $t2['L-gununggedangan-11'])
            ->setCellValue('X19', $t2['P-gununggedangan-11'])
            ->setCellValue('Y19', $t2['L-gununggedangan-12'])
            ->setCellValue('Z19', $t2['P-gununggedangan-12'])
            ...
            ->setCellValue('C44', $t3['LU-gununggedangan-1'])
            ->setCellValue('D44', $t3['LT-gununggedangan-1'])
            ->setCellValue('E44', $t3['LU-gununggedangan-2'])
            ->setCellValue('F44', $t3['LT-gununggedangan-2'])
            ->setCellValue('G44', $t3['LU-gununggedangan-3'])
            ->setCellValue('H44', $t3['LT-gununggedangan-3'])
            ->setCellValue('I44', $t3['LU-gununggedangan-4'])
            ->setCellValue('J44', $t3['LT-gununggedangan-4'])
            ->setCellValue('K44', $t3['LU-gununggedangan-5'])
            ->setCellValue('L44', $t3['LT-gununggedangan-5'])
            ->setCellValue('M44', $t3['LU-gununggedangan-6'])
            ->setCellValue('N44', $t3['LT-gununggedangan-6'])
            ->setCellValue('O44', $t3['LU-gununggedangan-7'])
            ->setCellValue('P44', $t3['LT-gununggedangan-7'])
            ->setCellValue('Q44', $t3['LU-gununggedangan-8'])
            ->setCellValue('R44', $t3['LT-gununggedangan-8'])
            ->setCellValue('S44', $t3['LU-gununggedangan-9'])
            ->setCellValue('T44', $t3['LT-gununggedangan-9'])
            ->setCellValue('U44', $t3['LU-gununggedangan-10'])
            ->setCellValue('V44', $t3['LT-gununggedangan-10'])
            ->setCellValue('W44', $t3['LU-gununggedangan-11'])
            ->setCellValue('X44', $t3['LT-gununggedangan-11'])
            ->setCellValue('Y44', $t3['LU-gununggedangan-12'])
            ->setCellValue('Z44', $t3['LT-gununggedangan-12'])
